...
import data.*;
import projectiles.ProjectileAntimatterMissile;
...
<<<<<<< HEAD
/**
 * Klasa AntimatterMissileLauncher zawiera m.in. metodę która implementuje
 * abstrakcyjną metodę shootabstrakcyjnej klasy Tower oraz dwie nadpisane metody.
 */
=======
>>>>>>> 5c362d4da769c490fc611112221bceb8bf02bb47
public class AntimatterMissileLauncher extends Tower {
    private int missileFiredInThisSeries;
    private int numberOfLaunchedSeries;
    private float timeSinceLastLaunch;

    public AntimatterMissileLauncher(TowerType type, Tile startTile, CopyOnWriteArrayList<Enemy> enemies) {
    ...
    public void shoot(Enemy target) {
        if (missileFiredInThisSeries == 0){
            this.calculateProjectilePositionModifier(10, 0);
            super.projectiles.add(new ProjectileAntimatterMissile(super.type.projectileType, super.target,
     ...
     *              - zwiększ numer serii. [Cztery serie przed ponownym załadowaniem prowadnic. Lącznie 12 prowadnic i rakiet]
     ...
     * Do zmiennej przechowującej czas od ostatnio wystrzelonych wszystki rakiet z 12 prowadnic dodaj czas jaki upłunął
