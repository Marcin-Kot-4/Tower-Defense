...
public class MachineGun extends Tower {
    ...
    public MachineGun(TowerType type, Tile startTile, CopyOnWriteArrayList<Enemy> enemies) {
        super(type, startTile, enemies);
        this.roundsInTheMagazine = 50;
    }
    ...
    public void shoot(Enemy target) {
        this.calculateProjectilePositionModifier(0, 20);
